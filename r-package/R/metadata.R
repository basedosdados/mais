...
#' @param query_project_id, a character, which project the table lives. You can change this you want to query different projects. Default is "basedosdados"
...
#' @examples 
#' \dotrun{
#' view_meta_table("br_denatran_frota.municipio_tipo")
#' }
...
view_meta_table <- function(dataset_id,
                            table_id,
...
#' @return \code{NULL}
#' @export
view_meta_dataset <- function(dataset_id,
                              query_project_id = "basedosdados",
                              billing_project_id = get_billing_id()
                              ) {
...
view_datasets <- function(query_project_id = "basedosdados",
                          filter_by = NULL,
...
#' @importFrom htmltools div h2 h4 p
#' @export
view_dataset_tables <- function(dataset_id,
                                query_project_id = "basedosdados",
                                filter_by = NULL,
                                with_description = FALSE,
                                page_size = 50,
...
render_dom <- function(body) {
  ...
  header <- function() {
    htmltools::div(
      ...
      htmltools::h1(
        class = "title",
        "Base dos Dados: Universalizando o acesso a dados no Brasil"
      ),
      htmltools::a(
