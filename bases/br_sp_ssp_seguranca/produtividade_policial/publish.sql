...
SAFE_CAST(no_de_armas_de_fogo_apreendidas AS INT64) no_de_armas_de_fogo_apreendidas,
SAFE_CAST(no_de_flagrantes_lavrados AS INT64) no_de_flagrantes_lavrados,
SAFE_CAST(no_de_infratores_apreendidos_em_flagrante AS INT64) no_de_infratores_apreendidos_em_flagrante,
SAFE_CAST(no_de_infratores_apreendidos_por_mandado AS INT64) no_de_infratores_apreendidos_por_mandado,
SAFE_CAST(no_de_pessoas_presas_em_flagrante AS INT64) no_de_pessoas_presas_em_flagrante,
SAFE_CAST(no_de_pessoas_presas_por_mandado AS INT64) no_de_pessoas_presas_por_mandado,
