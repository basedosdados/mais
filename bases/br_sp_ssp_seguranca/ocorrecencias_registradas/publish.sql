...
SAFE_CAST(no_de_vitimas_em_homicidio_doloso AS INT64) no_de_vitimas_em_homicidio_doloso,
SAFE_CAST(homicidio_doloso_por_acidente_de_transito AS INT64) homicidio_doloso_por_acidente_de_transito,
SAFE_CAST(no_de_vitimas_em_homicidio_doloso_por_acidente_de_transito AS INT64) no_de_vitimas_em_homicidio_doloso_por_acidente_de_transito,
...
SAFE_CAST(no_de_vitimas_em_latrocinio AS INT64) no_de_vitimas_em_latrocinio,
