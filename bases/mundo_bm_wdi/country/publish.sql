...
SAFE_CAST(national_accounts_reference_year AS FLOAT) national_accounts_reference_year,
...
SAFE_CAST(ppp_survey_year AS STRING) ppp_survey_year,
...
SAFE_CAST(latest_industrial_data AS FLOAT) latest_industrial_data,
SAFE_CAST(latest_trade_data AS FLOAT) latest_trade_data
