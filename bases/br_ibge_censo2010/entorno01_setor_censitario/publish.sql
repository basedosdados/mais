...
CREATE VIEW basedosdados.br_ibge_censo2010.entorno01_setor_censitario AS
SELECT 
...
from basedosdados-staging.br_ibge_censo2010_staging.entorno01_setor_censitario as t