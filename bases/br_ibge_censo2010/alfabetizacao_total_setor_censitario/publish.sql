...
CREATE VIEW basedosdados.br_ibge_censo2010.alfabetizacao_total_setor_censitario AS
SELECT 
...
from basedosdados-staging.br_ibge_censo2010_staging.alfabetizacao_total_setor_censitario as t
