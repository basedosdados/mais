...
import excel "input/divulgacao_anos_iniciais_municipios_2019/divulgacao_anos_iniciais_municipios_2019.xls", clear sheet("IDEB_AI_MUNICÍPIOS") allstring cellrange(A10) firstrow
...
reshape long	taxa_aprovacao_1_ao_5_ano_ ///
	...
	i(id_municipio municipio estado_abrev rede) j(ano)
...
import excel "input/divulgacao_anos_finais_municipios_2019/divulgacao_anos_finais_municipios_2019.xls", clear sheet("IDEB_AF_MUNICÍPIOS") allstring cellrange(A10) firstrow
...
import excel "input/divulgacao_ensino_medio_municipios_2019/divulgacao_ensino_medio_municipios_2019.xls", clear sheet("IDEB_Municípios (ENSINO MÉDIO)") allstring cellrange(A10) firstrow
