...
SAFE_CAST(nutricao_cuidados_medicos_basicos AS FLOAT64) nutricao_cuidados_medicos_basicos,
SAFE_CAST(agua_saneamento AS FLOAT64) agua_saneamento,
...
SAFE_CAST(acesso_conhecimento_basico AS FLOAT64) acesso_conhecimento_basico,
SAFE_CAST(acesso_informacao AS FLOAT64) acesso_informacao,
SAFE_CAST(saude_bem_estar AS FLOAT64) saude_bem_estar,
SAFE_CAST(qualidade_meio_ambiente AS FLOAT64) qualidade_meio_ambiente,
...
SAFE_CAST(tolerancia_inclusao AS FLOAT64) tolerancia_inclusao,
SAFE_CAST(acesso_educacao_superior AS FLOAT64) acesso_educacao_superior
