...
CREATE VIEW basedosdados-dev.br_ms_cnes.habilitacao AS
SELECT
...
SAFE_CAST(quantidade_leitos AS INT64) quantidade_leitos,
...
FROM basedosdados-dev.br_ms_cnes_staging.habilitacao AS t