...
SAFE_CAST(microregiao_saude AS STRING) microregiao_saude,
...
SAFE_CAST(data_contrato_municipal AS DATE) data_contrato_municipal,
...
SAFE_CAST(data_acreditacao AS DATE) data_acreditacao,
SAFE_CAST(avaliacao_pnass AS STRING) avaliacao_pnass,
SAFE_CAST(data_avaliacao_pnass AS DATE) data_avaliacao_pnass,
