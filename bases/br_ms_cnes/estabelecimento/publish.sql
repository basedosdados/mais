...
SAFE_CAST(data_atualizacao_ano AS STRING) data_atualizacao_ano,
SAFE_CAST(data_atualizacao_mes AS STRING) data_atualizacao_mes,
SAFE_CAST(data_competencia_ano AS STRING) data_competencia_ano,
SAFE_CAST(data_competencia_mes AS STRING) data_competencia_mes,
