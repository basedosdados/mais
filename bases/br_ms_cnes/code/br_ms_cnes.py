"""
Code for downloading the Brazilian MS-CNES dataset.
"""
# pylint: disable=invalid-name,duplicate-string-formatting-argument
import ftplib
...
for d in tipo:
    for a in uf:
        for b in ano:
            for c in mes:
                try:
                    link = "ftp://ftp.datasus.gov.br/dissemin/publicos/CNES/200508_/Dados/{}/{}{}{}{}.dbc".format(
                        d, d, a, b, c
                    )
                    wget.download(link)
                    print(d, a, b, c)
