...
CREATE VIEW basedosdados-dev.br_ibge_pof.outros_rendimentos_2017 AS
SELECT 
...
SAFE_CAST(V8501 AS FLOAT64) V8501,
SAFE_CAST(V8501_deflacionado AS FLOAT64) V8501_deflacionado,
SAFE_CAST(renda_total AS FLOAT64) renda_total,
SAFE_CAST(peso AS FLOAT64) peso,
SAFE_CAST(peso_final AS FLOAT64) peso_final
FROM basedosdados-dev.br_ibge_pof_staging.outros_rendimentos_2017 AS t