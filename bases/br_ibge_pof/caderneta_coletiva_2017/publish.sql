...
CREATE VIEW basedosdados-dev.br_ibge_pof.caderneta_coletiva_2017 AS
SELECT 
...
SAFE_CAST(V9004 AS STRING) V9004,
SAFE_CAST(V9007 AS STRING) V9007,
SAFE_CAST(V9009 AS STRING) V9009,
SAFE_CAST(V9005 AS FLOAT64) V9005,
SAFE_CAST(quantidade_final AS FLOAT64) quantidade_final,
...
FROM basedosdados-dev.br_ibge_pof_staging.caderneta_coletiva_2017 AS t