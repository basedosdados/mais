...
CREATE VIEW basedosdados-dev.br_ibge_pof.despesa_coletiva_2017 AS
SELECT 
...
SAFE_CAST(indicador_imputacao_qtd AS INT64) indicador_imputacao_qtd,
...
FROM basedosdados-dev.br_ibge_pof_staging.despesa_coletiva_2017 AS t