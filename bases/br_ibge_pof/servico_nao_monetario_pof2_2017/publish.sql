...
CREATE VIEW basedosdados-dev.br_ibge_pof.servico_nao_monetario_pof2_2017 AS
SELECT 
...
FROM basedosdados-dev.br_ibge_pof_staging.servico_nao_monetario_pof2_2017 AS t