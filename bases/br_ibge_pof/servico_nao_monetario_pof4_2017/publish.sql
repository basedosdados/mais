...
CREATE VIEW basedosdados-dev.br_ibge_pof.servico_nao_monetario_pof4_2017 AS
SELECT 
...
SAFE_CAST(V4104 AS STRING) V4104,
SAFE_CAST(V4105 AS STRING) V4105,
...
FROM basedosdados-dev.br_ibge_pof_staging.servico_nao_monetario_pof4_2017 AS t