...
SAFE_CAST(idhm_e_subescolaridade AS STRING) idhm_e_subescolaridade,
SAFE_CAST(idhm_e_subfrequencia AS STRING) idhm_e_subfrequencia,
SAFE_CAST(prosperidade_social AS STRING) prosperidade_social,
SAFE_CAST(porporcao_vulnerabilidade_socioeconomica AS FLOAT64) porporcao_vulnerabilidade_socioeconomica,
...
SAFE_CAST(proporcao_vulneravel_15_24 AS INT64) proporcao_vulneravel_15_24,
...
SAFE_CAST(proporcao_mortalidade_1_menos AS FLOAT64) proporcao_mortalidade_1_menos,
...
SAFE_CAST(proporcao_maternidade_crianca_15_menos AS STRING) proporcao_maternidade_crianca_15_menos,
