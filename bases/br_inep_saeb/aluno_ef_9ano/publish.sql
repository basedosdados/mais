...
SAFE_CAST(bloco_aberto_1 AS STRING) bloco_aberto_1,
SAFE_CAST(bloco_aberto_2 AS STRING) bloco_aberto_2,
SAFE_CAST(item_bloco AS STRING) item_bloco,
SAFE_CAST(respostas AS STRING) respostas,
...
SAFE_CAST(estrato_ciencias AS STRING) estrato_ciencias,
...
SAFE_CAST(mora_conjugue AS STRING) mora_conjugue,
...
SAFE_CAST(possui_diarista AS STRING) possui_diarista,
...
SAFE_CAST(frequencia_responsaveis_conversam_diretor AS STRING) frequencia_responsaveis_conversam_diretor,
SAFE_CAST(frequencia_responsaveis_conversam_professor AS STRING) frequencia_responsaveis_conversam_professor,
...
SAFE_CAST(evasao_escolar_volta_antes_final_ano AS STRING) evasao_escolar_volta_antes_final_ano,
...
SAFE_CAST(frequenta_concerto AS STRING) frequenta_concerto,
