...
CREATE VIEW basedosdados-dev.br_inep_indicadores_educacionais.curso_de_para_anual AS
SELECT 
...
SAFE_CAST(tipo_organizacao AS INT64) tipo_organizacao_academica,
...
SAFE_CAST(tipo_grau_academico INT64) tipo_grau_academico,
...
SAFE_CAST(qtde_ingressante AS INT64) qtde_ingressante,
SAFE_CAST(qtde_permanencia AS INT64) qtde_permanencia,
SAFE_CAST(qtde_concluinte AS INT64) qtde_concluinte,
SAFE_CAST(qtde_desistencia AS INT64) qtde_desistencia,
SAFE_CAST(qtde_falecido AS INT64) qtde_falecido,
...
from basedosdados-dev.br_inep_indicadores_educacionais_staging.curso_de_para_anual as t