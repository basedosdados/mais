...
CREATE VIEW basedosdados-dev.br_inep_indicadores_educacionais.brasil_remuneracao_docentes AS
SELECT 
...
from basedosdados-dev.br_inep_indicadores_educacionais_staging.brasil_remuneracao_docentes as t