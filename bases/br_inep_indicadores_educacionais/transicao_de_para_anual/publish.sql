...
SAFE_CAST(ano_base AS INT64) ano_base,
SAFE_CAST(proximo_ano AS INT64) proximo_ano,
...
SAFE_CAST(taxa_evasao_eja_ensino_fund AS FLOAT64) taxa_evasao_eja_ensino_fund,
SAFE_CAST(taxa_evasao_eja_ensino_fund_anos_iniciais AS FLOAT64) taxa_evasao_eja_ensino_fund_anos_iniciais,
SAFE_CAST(taxa_evasao_eja_ensino_fund_anos_finais AS FLOAT64) taxa_evasao_eja_ensino_fund_anos_finais,
SAFE_CAST(taxa_evasao_eja_ensino_fund_1_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_1_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_2_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_2_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_3_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_3_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_4_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_4_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_5_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_5_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_6_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_6_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_7_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_7_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_8_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_8_ano,
SAFE_CAST(taxa_evasao_eja_ensino_fund_9_ano AS FLOAT64) taxa_evasao_eja_ensino_fund_9_ano,
SAFE_CAST(taxa_evasao_eja_ensino_medio AS FLOAT64) taxa_evasao_eja_ensino_medio,
