...
tjes_15_19 <- read.csv2("indicadores_trajetoria_educacao_superior_2015_2019.xlsx")
...
con <- file('fluxo_educacao_superior.csv', encoding = "UTF-8")
write.csv(tjes, file = con, row.names = FALSE)
