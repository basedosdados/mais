...
tx_17_18$ano_base <- "2017"   
tx_17_18$proximo_ano <- "2018"
...
tx_16_17$ano_base <- "2016"
tx_16_17$proximo_ano <- "2017"
...
tx_15_16$ano_base <- "2015"
tx_15_16$proximo_ano <- "2016"
...
tx_14_15$ano_base <- "2014"
tx_14_15$proximo_ano <- "2015"
...
tx_13_14$ano_base <- "2013"
tx_13_14$proximo_ano <- "2014"
...
tx_12_13$ano_base <- "2012"
tx_12_13$proximo_ano <- "2013"
...
tx_11_12$ano_base <- "2011"
tx_11_12$proximo_ano <- "2012"
...
tx_10_11$ano_base <- "2010"
tx_10_11$proximo_ano <- "2011"
...
tx_09_10$ano_base <- "2009"
tx_09_10$proximo_ano <- "2010"
...
tx_08_09$ano_base <- "2008"
tx_08_09$proximo_ano <- "2009"
...
tx_07_08$ano_base <- "2007"
tx_07_08$proximo_ano <- "2008"
...
colnames(tx_transicao_01) <- c("id_municipio","situacao","rede","taxa_promocao_ensino_fund","taxa_promocao_ensino_fund_anos_iniciais","taxa_promocao_ensino_fund_anos_finais","taxa_promocao_ensino_fund_1_ano"
                        ...
                        ,"taxa_evasao_ensino_fund_2_ano","taxa_evasao_ensino_fund_3_ano","taxa_evasao_ensino_fund_4_ano","taxa_evasao_ensino_fund_5_ano","taxa_evasao_ensino_fund_6_ano","taxa_evasao_ensino_fund_7_ano","taxa_evasao_ensino_fund_8_ano","taxa_evasao_ensino_fund_9_ano","taxa_evasao_ensino_medio","taxa_evasao_ensino_medio_1_ano","taxa_evasao_ensino_medio_2_ano","taxa_evasao_ensino_medio_3_ano","taxa_migracao_eja_ensino_fund","taxa_migracao_eja_ensino_fund_anos_iniciais","taxa_migracao_eja_ensino_fund_anos_finais","taxa_migracao_eja_ensino_fund_1_ano"
                        ,"taxa_migracao_eja_ensino_fund_2_ano","taxa_migracao_eja_ensino_fund_3_ano","taxa_migracao_eja_ensino_fund_4_ano","taxa_migracao_eja_ensino_fund_5_ano","taxa_migracao_eja_ensino_fund_6_ano","taxa_migracao_eja_ensino_fund_7_ano","taxa_migracao_eja_ensino_fund_8_ano","taxa_migracao_eja_ensino_fund_9_ano","taxa_migracao_eja_ensino_medio","taxa_migracao_eja_ensino_medio_1_ano","taxa_migracao_eja_ensino_medio_2_ano","taxa_migracao_eja_ensino_medio_3_ano","ano_base","proximo_ano")
...
tx_transicao <- tx_transicao %>% relocate(ano_base, .after = rede)
tx_transicao <- tx_transicao %>% relocate(proximo_ano, .after = ano_base)

tx_transicao$id_municipio <- as.integer(tx_transicao$id_municipio)
tx_transicao$ano_base <- as.integer(tx_transicao$ano_base)
tx_transicao$proximo_ano <- as.integer(tx_transicao$proximo_ano)
