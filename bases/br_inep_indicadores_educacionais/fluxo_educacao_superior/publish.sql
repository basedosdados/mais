...
SAFE_CAST(tipo_organizacao AS STRING) tipo_organizacao,
...
SAFE_CAST(tipo_modalidade AS STRING) tipo_modalidade,
SAFE_CAST(id_cine_rotulo AS STRING) id_cine_rotulo,
SAFE_CAST(nome_cine_rotulo AS STRING) nome_cine_rotulo,
SAFE_CAST(id_cine_area_geral AS STRING) id_cine_area_geral,
