...
CREATE VIEW basedosdados-dev.br_isp_estatisticas_seguranca.taxa_evolucao_mensal_uf AS
SELECT 
...
from basedosdados-dev.br_isp_estatisticas_seguranca_staging.taxa_evolucao_mensal_uf as t