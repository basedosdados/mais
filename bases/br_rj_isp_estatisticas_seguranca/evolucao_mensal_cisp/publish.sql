...
SAFE_CAST(quantidade_crimes_violentos_letais_intencionais AS STRING) quantidade_crimes_violentos_letais_intencionais,
...
SAFE_CAST(quantidade_outros_roubos AS STRING) quantidade_outros_roubos,
...
SAFE_CAST(quantidade_outros_furtos AS STRING) quantidade_outros_furtos,
...
SAFE_CAST(quantidade_registro_posse_drogas AS STRING) quantidade_registro_posse_drogas,
SAFE_CAST(quantidade_registro_trafico_drogas AS STRING) quantidade_registro_trafico_drogas,
SAFE_CAST(quantidade_registro_apreensao_drogas_sem_autor AS STRING) quantidade_registro_apreensao_drogas_sem_autor,
...
SAFE_CAST(quantidade_pessoas_desaparecidas AS STRING) quantidade_pessoas_desaparecidas,
