...
CREATE VIEW basedosdados-dev.br_rj_isp_estatisticas_seguranca.taxa_evolucao_mensal_municipio AS
SELECT 
...
SAFE_CAST(taxa_roubo_veiculo AS STRING) taxa_roubo_veiculo,
