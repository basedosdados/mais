...
SAFE_CAST(id_tipo_atividade_1 AS INT64) tipo_atividade_1,
SAFE_CAST(id_tipo_atividade_2 AS INT64) tipo_atividade_2,
SAFE_CAST(id_tipo_atividade_3 AS INT64) tipo_atividade_3,
SAFE_CAST(id_tipo_atividade_4 AS INT64) tipo_atividade_4,
SAFE_CAST(id_tipo_atividade_5 AS INT64) tipo_atividade_5,
SAFE_CAST(id_tipo_atividade_6 AS INT64) tipo_atividade_6,
SAFE_CAST(id_curso_educ_profissional AS STRING) id_curso_educacao_profissional,
