...
CREATE VIEW basedosdados-dev.br_inep_censo_escolar.escolas AS
SELECT 
...
SAFE_CAST(dt_ano_letivo_inicio AS DATE) dt_ano_letivo_inicio,
SAFE_CAST(dt_ano_letivo_termino AS DATE) dt_ano_letivo_termino,
...
from basedosdados-dev.br_inep_censo_escolar_staging.escolas as t