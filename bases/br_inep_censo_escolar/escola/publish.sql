...
SAFE_CAST(tipo_poder_publico_parceria AS STRING) tipo_poder_publico_parceria,
...
SAFE_CAST(forma_contratacao_termo_colaboracao AS INT64) forma_contratacao_termo_colaboracao,
SAFE_CAST(forma_contratacao_termo_fomento AS INT64) forma_contratacao_termo_fomento,
SAFE_CAST(forma_contratacao_acordo_cooperacao AS INT64) forma_contratacao_acordo_cooperacao,
SAFE_CAST(forma_contratacao_prestacao_servico AS INT64) forma_contratacao_prestacao_servico,
SAFE_CAST(forma_contratacao_cooperacao_tecnica_financeira AS INT64) forma_contratacao_cooperacao_tecnica_financeira,
SAFE_CAST(forma_contratacao_consorcio_publico AS INT64) forma_contratacao_consorcio_publico,
SAFE_CAST(tipo_atendimento_escolarizacao AS INT64) tipo_atendimento_escolarizacao,
SAFE_CAST(tipo_atendimento_atividade_complementar AS INT64) tipo_atendimento_atividade_complementar,
...
SAFE_CAST(laboratorio_educacao_profissional AS INT64) laboratorio_educacao_profissional,
...
SAFE_CAST(sala_oficinas_educacao_profissional AS INT64) sala_oficinas_educacao_profissional,
...
SAFE_CAST(material_pedagogico_profissional AS INT64) material_pedagogico_profissional,
