...
SAFE_CAST(tipo_ocupacao_galpao AS STRING) tipo_ocupacao_galpao,
...
SAFE_CAST(tipo_atendimento_educacional_especial AS STRING) tipo_atendimento_educacional_especial,
