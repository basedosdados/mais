...
CREATE VIEW basedosdados-dev.br_ieps_saude.macrorregiao AS
SELECT 
SAFE_CAST(ano AS INT64) ano,
SAFE_CAST(sigla_uf AS STRING) sigla_uf,
SAFE_CAST(id_macrorregiao AS STRING) id_macrorregiao,
SAFE_CAST(nome_macrorregiao AS STRING) nome_macrorregiao,
...
FROM basedosdados-dev.br_ieps_saude_staging.macrorregiao AS t