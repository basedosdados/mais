...
SAFE_CAST(porcentagem_cobertura_estrategia_saude_familia AS FLOAT64) porcentagem_cobertura_estrategia_saude_familia,
SAFE_CAST(populacao_coberta_total_atencao_basica AS INT64) populacao_coberta_total_atencao_basica,
SAFE_CAST(porcentagem_cobertura_total_atencao_basica AS FLOAT64) porcentagem_cobertura_total_atencao_basica
