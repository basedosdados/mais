...
CREATE VIEW basedosdados-dev.br_isp_estatisticas_seguranca.evolucao_mensal_uf AS
SELECT 
...
from basedosdados-dev.br_isp_estatisticas_seguranca_staging.evolucao_mensal_uf as t