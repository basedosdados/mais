...
CREATE VIEW basedosdados-dev.br_isp_estatisticas_seguranca.taxa_evolucao_anual_municipio AS
SELECT
...
SAFE_CAST(cvli AS FLOAT64) cvli,
...
SAFE_CAST(roubo_rua AS FLOAT64) roubo_rua,
...
SAFE_CAST(pol_militares_mortos_serv AS FLOAT64) pol_militares_mortos_serv,
SAFE_CAST(pol_civis_mortos_serv AS FLOAT64) pol_civis_mortos_serv,
SAFE_CAST(registro_ocorrencias AS FLOAT64) registro_ocorrencias,
SAFE_CAST(fase AS FLOAT64) fase
from basedosdados-dev.br_isp_estatisticas_seguranca_staging.taxa_evolucao_anual_municipio as t