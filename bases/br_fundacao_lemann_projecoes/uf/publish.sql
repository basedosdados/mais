...
CREATE VIEW basedosdados-dev.br_fundacao_lemann_projecoes.uf AS
SELECT 
...
SAFE_CAST(numero_matriculas_publica AS FLOAT64) numero_matriculas_publica,
...
SAFE_CAST(numero_matriculas_privada AS FLOAT64) numero_matriculas_privada,
...
SAFE_CAST(familias_beneficiarias_pbf AS FLOAT64) familias_beneficiarias_pbf,
...
FROM basedosdados-dev.br_fundacao_lemann_projecoes_staging.uf AS t