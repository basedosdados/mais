...
CREATE VIEW basedosdados-dev.br_cgu_servidores_executivo_federal.servidor_civil_ativo_remuneracao AS
SELECT 
...
FROM basedosdados-dev.br_cgu_servidores_executivo_federal_staging.servidor_civil_ativo_remuneracao AS t