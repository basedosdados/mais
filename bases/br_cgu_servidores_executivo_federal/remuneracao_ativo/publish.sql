...
CREATE VIEW basedosdados-dev.br_cgu_servidores_executivo_federal.remuneracao_ativo AS
SELECT 
...
FROM basedosdados-dev.br_cgu_servidores_executivo_federal_staging.remuneracao_ativo AS t