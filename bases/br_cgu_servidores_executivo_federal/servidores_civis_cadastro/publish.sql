...
SELECT 
    ...
    SAFE_CAST(id_servidor AS INT64) id_servidor,
    ...
    SAFE_CAST(cod_atividade AS INT64) id_atividade,
    SAFE_CAST(atividade AS STRING) atividade,
    SAFE_CAST(opcao_parcial AS STRING) opcao_parcial,
    SAFE_CAST(cod_uorg_lotacao AS INT64) id_uorg_lotacao,
    SAFE_CAST(uorg_lotacao AS STRING) uorg_lotacao,
    SAFE_CAST(cod_org_lotacao AS INT64) id_org_lotacao,
    SAFE_CAST(org_lotacao AS STRING) org_lotacao,
    SAFE_CAST(cod_orgsup_lotacao AS INT64) id_orgsup_lotacao,
    SAFE_CAST(orgsup_lotacao AS STRING) orgsup_lotacao,
    SAFE_CAST(cod_uorg_exercicio AS INT64) id_uorg_exercicio,
    SAFE_CAST(uorg_exercicio AS STRING) uorg_exercicio,
    SAFE_CAST(cod_org_exercicio AS INT64) id_org_exercicio,
    SAFE_CAST(org_exercicio AS STRING) org_exercicio,
    SAFE_CAST(cod_orgsup_exercicio AS INT64) id_orgsup_exercicio,
