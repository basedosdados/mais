...
# Abrindo a base
idesp_iniciais <- import("seduc/IDESP_Escolas_2007_2019_AI.csv", setclass = "tibble")
idesp_finais <- import("seduc/IDESP_Escolas_2007_2019_AF.csv", setclass= "tibble")
idesp_medio <-import("seduc/IDESP_Escolas_2007_2019_EM.csv", setclass = "tibble")
...
# Juntando ensino fundamental com ensino médio
idesp_long <-idesp_ef%>%
  bind_rows(idesp_em)

# Mergindo com o diretório de escolas para termos id_municipio de onde esta cada escola
...
# Executando a query
query <- 'SELECT id_escola, id_municipio
FROM `basedosdados.br_inep_ideb.escola`
WHERE ano = 2019
GROUP BY id_escola, id_municipio'
...
# Exportando os dados
export(idesp_long_identificado, "basesprontas/idesp_fundamental_medio.csv")
