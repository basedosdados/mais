...
CREATE VIEW basedosdados.br_imprensa_nacional_dou.original AS
SELECT 
  ...
  part_secao AS particao_secao_edicao
FROM `gabinete-compartilhado.views_publicos.dou_campos_selecionados_limpos`
