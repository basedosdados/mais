...
CREATE VIEW basedosdados-dev.world_fifa_worldcup.matches AS
SELECT 
...
SAFE_CAST(replayed AS INT64) replayed,
SAFE_CAST(replay AS INT64) replay,
SAFE_CAST(match_date AS DATE) match_date,
SAFE_CAST(match_time AS TIME) match_time,
SAFE_CAST(stadium_id AS STRING) stadium_id,
...
FROM basedosdados-dev.world_fifa_worldcup_staging.matches AS t