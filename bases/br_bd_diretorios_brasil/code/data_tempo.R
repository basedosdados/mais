...
setwd("path/to/br_bd_diretorios_data_tempo")
...
df.data = as.data.frame(seq(lubridate::ymd("0000-01-01"), lubridate::ymd("5000-12-31"), by=1))
...
df = as.data.frame(seq(lubridate::ym("0000-01"), lubridate::ym("5000-12"), by=1))
colnames(df) = "data"

df = as.data.frame(seq(lubridate::ymd("0000-01-01"), lubridate::ymd("5000-12-31"), by=1))
colnames(df) = "mes"
