"""
Code for downloading data of regional_metropolitan_area
"""
...
with ftplib.FTP("geoftp.ibge.gov.br") as ftp:
    ftp.login()
    ftp.dir(
        "organizacao_do_territorio/estrutura_territorial/municipios_por_regioes_metropolitanas/Situacao_2020a2029/Composicao_RMs_RIDEs_AglomUrbanas_2020_12_31.xlsx"
    )

df = wget.download(
    "https://geoftp.ibge.gov.br/organizacao_do_territorio/estrutura_territorial/municipios_por_regioes_metropolitanas/Situacao_2020a2029/Composicao_RMs_RIDEs_AglomUrbanas_2020_12_31.xlsx",
...
list_ordem = ["sigla_uf", "id_regiao_metropolitana", "tipo", "nome", "nome_regiao"]
