...
SAFE_CAST(regiao_saude AS string) nome_regiao_saude,
SAFE_CAST(id_regiao_imediata AS string) id_regiao_imediata,
SAFE_CAST(regiao_imediata AS string) nome_regiao_imediata,
SAFE_CAST(id_regiao_intermediaria AS string) id_regiao_intermediaria,
SAFE_CAST(regiao_intermediaria AS string) nome_regiao_intermediaria,
SAFE_CAST(id_microrregiao AS string) id_microrregiao,
SAFE_CAST(microrregiao AS string) nome_microrregiao,
SAFE_CAST(id_mesorregiao AS string) id_mesorregiao,
SAFE_CAST(mesorregiao AS string) nome_mesorregiao,
