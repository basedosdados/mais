...
for i in list_anos:  
  for uf in ufs:
    ...
    directory = path_dados + 'output/microdados_compatibilizados_domicilio/ano={}/sigla_uf={}'.format(i, uf)
    if not os.path.exists(directory):
      os.makedirs(directory)
    
    directory = path_dados + 'output/microdados_compatibilizados_pessoa/ano={}/sigla_uf={}'.format(i, uf)
    if not os.path.exists(directory):
      os.makedirs(directory)
...
for ano in list_anos:
  ...
  for uf in ufs:
    ...
    partition_path = path_dados + 'output/microdados_compatibilizados_domicilio/ano={}/sigla_uf={}/microdados_compatibilizados_domicilio.csv'.format(ano,uf)
    ...
    df_partition.drop(['sigla_uf', 'ano'], axis=1, inplace=True)
    partition_path = path_dados + 'output/microdados_compatibilizados_pessoa/ano={}/sigla_uf={}/microdados_compatibilizados_pessoa.csv'.format(ano,uf)
    df_partition.to_csv(partition_path, index=False, encoding='utf-8', na_rep='',  float_format='%.0f')