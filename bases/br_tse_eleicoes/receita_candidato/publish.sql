...
CREATE VIEW basedosdados.br_tse_eleicoes.receita_candidato AS
SELECT 
...
SAFE_CAST(sequencial_receita AS INT64) sequencial_receita,
SAFE_CAST(data_receita AS DATE) data_receita,
SAFE_CAST(tipo_receita AS STRING) tipo_receita,
SAFE_CAST(tipo_fonte_receita AS STRING) tipo_fonte_receita,
...
SAFE_CAST(sequencial_candidato_doador AS INT64) sequencial_candidato_doador,
SAFE_CAST(cpf_cnpj_doador AS STRING) cpf_cnpj_doador,
SAFE_CAST(sigla_uf_doador AS STRING) sigla_uf_doador,
SAFE_CAST(id_municipio_tse_doador AS INT64) id_municipio_tse_doador,
...
SAFE_CAST(numero_partido_doador AS INT64) numero_partido_doador,
...
SAFE_CAST(numero_candidato_doador AS INT64) numero_candidato_doador,
SAFE_CAST(id_setor_economico_doador AS STRING) id_setor_economico_doador,
SAFE_CAST(setor_economico_doador AS STRING) setor_economico_doador,
...
SAFE_CAST(setor_economico_doador_orig AS STRING) setor_economico_doador_orig,
...
from basedosdados-staging.br_tse_eleicoes_staging.receita_candidato as t