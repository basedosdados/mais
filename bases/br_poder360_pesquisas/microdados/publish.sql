...
SAFE_CAST(quantidade_entrevistas AS INT64) quantidade_entrevistas,
SAFE_CAST(margem_mais AS INT64) margem_mais,
SAFE_CAST(margem_menos AS INT64) margem_menos,
