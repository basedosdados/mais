...
SELECT
SAFE_CAST(sequencial_sessao AS INT64) sequencial_sessao,
...
SAFE_CAST(horario_inicio_discurso AS DATETIME) horario_inicio_discurso,
SAFE_CAST(horario_fim_discurso AS DATETIME) horario_fim_discurso,
