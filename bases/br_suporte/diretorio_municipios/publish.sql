...
SAFE_CAST(capital_estado AS BOOL) capital_estado,
...
SAFE_CAST(existia_1991 AS BOOL) existia_1991,
SAFE_CAST(existia_2000 AS BOOL) existia_2000,
SAFE_CAST(existia_2010 AS BOOL) existia_2010
