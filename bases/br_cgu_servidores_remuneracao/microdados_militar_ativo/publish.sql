...
CREATE VIEW basedosdados-dev.br_cgu_servidores_remuneracao.microdados_militar_ativo AS
SELECT 
...
FROM basedosdados-dev.br_cgu_servidores_remuneracao_staging.microdados_militar_ativo AS t