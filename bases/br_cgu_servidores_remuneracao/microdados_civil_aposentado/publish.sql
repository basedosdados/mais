...
CREATE VIEW basedosdados-dev.br_cgu_servidores_remuneracao.microdados_civil_aposentado AS
SELECT 
...
FROM basedosdados-dev.br_cgu_servidores_remuneracao_staging.microdados_civil_aposentado AS t