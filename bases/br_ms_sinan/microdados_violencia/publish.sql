...
CREATE VIEW projetos-bd.br_ms_sinan.microdados_violencia AS
SELECT 
...
SAFE_CAST(ocupacao_paciente AS INT64) ocupacao_paciente,
SAFE_CAST(estado_civil_paciente AS INT64) estado_civil_paciente,
...
FROM projetos-bd.br_ms_sinan_staging.microdados_violencia AS t