...
SAFE_CAST(area_lavoura_permanente AS FLOAT64) area_lavoura_permanente,
...
SAFE_CAST(area_cafe AS FLOAT64) area_cafe,
...
SAFE_CAST(areas_irrigacao AS FLOAT64) areas_irrigacao,
...
SAFE_CAST(numero_estabelecimentos_arrendatario AS INT64) numero_estabelecimentos_arrendatario,
...
SAFE_CAST(numero_estabelecimentos_cooperativas AS INT64) numero_estabelecimentos_cooperativas,
...
SAFE_CAST(quantidade_maquinas_plantio AS INT64) quantidade_maquinas_plantio,
...
SAFE_CAST(pessoal_14_mais_empregadas AS INT64) pessoal_14_mais_empregadas,
SAFE_CAST(pessoal_14_mais_ocupado AS INT64) pessoal_14_mais_ocupado,
SAFE_CAST(valor_producao_total AS FLOAT64) valor_producao_total,
SAFE_CAST(valor_producao_total_animal AS FLOAT64) valor_producao_total_animal,
...
SAFE_CAST(proporcao_despesa_salarios AS FLOAT64) proporcao_despesa_salarios
