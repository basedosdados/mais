...
CREATE VIEW basedosdados-dev.br_inep_indicador_nivel_socioeconomico.municipio AS
SELECT 
...
FROM basedosdados-dev.br_inep_indicador_nivel_socioeconomico_staging.municipio AS t