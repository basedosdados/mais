...
CREATE VIEW basedosdados-dev.br_inep_indicador_nivel_socioeconomico.escola AS
SELECT 
...
FROM basedosdados-dev.br_inep_indicador_nivel_socioeconomico_staging.escola AS t