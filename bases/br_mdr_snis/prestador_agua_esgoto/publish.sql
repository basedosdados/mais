...
CREATE VIEW basedosdados-dev.br_mdr_snis.prestador_agua_esgoto AS
SELECT 
...
SAFE_CAST(quantidade_municipios_agua_delegacao_vigor AS INT64) quantidade_municipios_agua_delegacao_vigor,
SAFE_CAST(quantidade_municipios_esgoto_delegacao_vigor AS INT64) quantidade_municipios_esgoto_delegacao_vigor,
SAFE_CAST(quantidade_municipios_agua_delegacao_vencida AS INT64) quantidade_municipios_agua_delegacao_vencida,
SAFE_CAST(quantidade_municipios_esgoto_delegacao_vencida AS INT64) quantidade_municipios_esgoto_delegacao_vencida,
SAFE_CAST(quantidade_municipios_agua_sem_delegacao AS INT64) quantidade_municipios_agua_sem_delegacao,
SAFE_CAST(quantidade_municipios_esgoto_sem_delegacao AS INT64) quantidade_municipios_esgoto_sem_delegacao,
SAFE_CAST(quantidade_municipios_sem_esgoto_sem_delegacao AS INT64) quantidade_municipios_sem_esgoto_sem_delegacao,
