...
#CHECANDO COISAS QUE PODEM ESTAR ERRADAS
assert_all_are_in_closed_range(x = c(agricola_permanente_final$perc_valor_prod, agricola_permanente_final$perca_colhida, 
                                 agricola_permanente_final$perc_a_dedcolheita), lower = 0, upper = 1, na_ignore = TRUE)
